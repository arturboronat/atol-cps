...
class CPSModelBuilderUtil {
	...
	// Artur
	def prepareEmptyModel(String cpsId, String basePath, String name) {
		val rs = new ResourceSetImpl()
		val cpsRes = rs.createResource(URI.createFileURI('''«basePath»/«name».cps.xmi'''))
		val depRes = rs.createResource(URI.createFileURI('''«basePath»/«name».deployment.xmi'''))
		val trcRes = rs.createResource(URI.createFileURI('''«basePath»/«name».traceability.xmi'''))
